...
def carga_parametros(parameter_loader: Parameter_Loader, files_loader: Parameter_Loader) -> None:
    ...
    shutil.copyfile(files_loader.parameters['archivo_calculos'], f'{parameter_loader.parameters["ruta_output"]}{files_loader.parameters["archivo_calculos"]}')
    shutil.copyfile(files_loader.parameters['archivo_parametros'], f'{parameter_loader.parameters["ruta_output"]}{files_loader.parameters["archivo_parametros"]}')
